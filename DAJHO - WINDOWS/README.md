...
👉 **[Descargar DAJHO v1.0.0](https://github.com/DavisDaniel16/DAJHO/releases/tag/v1.0.0)**

Solo descarga el archivo `DAJHO Setup 1.0.0.exe` e instálalo. No requiere Node.js ni conocimientos técnicos.

### 🔑 Credenciales
| Usuario | Contraseña | Rol |
|---------|-----------|-----|
| `propietario` | `propietario123` | 🔓 Acceso total |
...
│           │   ├── InactivityModal.tsx     # Modal de inactividad
│           │   ├── PasswordConfirm.tsx     # Confirmación de contraseña
│           │   ├── layout/
...
│               └── Ayuda.tsx               # Página de ayuda y contacto
...
👉 **[Descargar última versión](https://github.com/DavisDaniel16/DAJHO/releases/latest)**

Solo ejecuta el archivo `.exe` y sigue los pasos. No necesitas instalar Node.js ni nada adicional.
